...
public class Session {
    ...
    public Session(int therp_id, int user_id, String title, String description, int num_of_days, Timestamp created_at, Timestamp modified_at, Timestamp is_deleted, Timestamp deleted_at) {
